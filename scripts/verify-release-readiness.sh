...
require_absent_pattern "NaymNaymLevelUp README.md docs release marketing-site/dist" "아이 폰|한입 도전|한입 도전자" "No awkward Korean release copy spacing"
...
require_pattern "NaymNaymLevelUp/Views/Settings/SettingsView.swift" "부모 연결은 초대 코드와 사용자가 선택한 공유 기록만 동기화합니다" "App info discloses server sync for parent sharing"
