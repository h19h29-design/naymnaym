...
require_pattern "android/app/build.gradle" "versionCode 4" "Android versionCode is bumped for Play test upload"
require_pattern "android/app/build.gradle" "versionName \"1\\.0-android-test4\"" "Android versionName is updated for Play test upload"
