...
Lite v2는 네 경로와 세 탭으로 제한했다. 오늘 화면이 급식·알레르기·식사 기록·성장을 한 흐름으로 묶고, 주간 화면은 native main의 `ko_KR` school-week 규칙과 같은 월요일~일요일을 `fetchMealsRange` 한 번으로 표시한다. 보호자 연결, 계정, 사진, 공유, 알림, 광고, 분석, 월간과 도감은 제외했다.
